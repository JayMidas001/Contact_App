    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Hello ${fullName},</p>
            <p>Thank you for joining our app! We're thrilled to have you on board.</p>
            <p>Please click the button below to verify your account:</p>
            <p>
              <a href="${verifyLink}" class="button">Verify My Account</a>
            </p>
            <p>If you did not create an account, please ignore this email.</p>
            <p>Best regards,<br>Contact App Team</p>
          </div>
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} Contact App. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
